...
import static org.discobot.beans.Introspector.decapitalize;
...
class StandardBeanInfo extends SimpleBeanInfo {
	...
	//HE: Fixed accessors
        subDesc.setHidden(subDesc.isHidden() | superDesc.isHidden());
        subDesc.setExpert(subDesc.isExpert() | superDesc.isExpert());
        subDesc.setPreferred(subDesc.isPreferred() | superDesc.isPreferred());
        subDesc.setBound(subDesc.isBound() | superDesc.isBound());
        subDesc.setConstrained(subDesc.isConstrained() | superDesc.isConstrained());
        subDesc.setName(superDesc.getName());
        if (subDesc.getShortDescription() == null
                && superDesc.getShortDescription() != null) {
            subDesc.setShortDescription(superDesc.getShortDescription());
        }
        if (subDesc.getDisplayName() == null && superDesc.getDisplayName() != null) {
            subDesc.setDisplayName(superDesc.getDisplayName());
        }
    }
